...
For the flow (1), if the bridge flow is a global gradient, $B\in\im D_0$, then under any filling
\[
\|\Ph Y\|^2=\|\Ph Y_{cc}\|^2,
\]
...
one-to-one; \S7 measures which of them satisfy the corollary's hypothesis and
which do not.
...
relative to the global potential of (1). The rig's fresh and persistent coins are
