...
at 0.019 for b₁ = 1 and 0.120 for b₁ = 22 — the largest rungs passing both
moment checks across 0.010 to 0.25, ten base seeds per level. Quote the criterion
with the number: first-failing gives 0.030/0.180 and variance-alone gives
0.050/0.180, and the probe exports the third while the prose quoted the second. A flat 0.02 is safe for every b₁ measured; indexing by b₁ buys headroom.
