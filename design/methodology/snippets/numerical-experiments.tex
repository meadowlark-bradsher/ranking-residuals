...
% design/methodology/figdata/*.json in the ranking-residuals repo. Where a value
...
the non-linear $\mathcal{O}(1/k^2)$ logit-bias term. Fitting across a full
unwindowed grid ($k \in [8, 1024]$) artificially shifts the intercept upward to
$0.220$ against a true misspecification oracle of $\epsilon^2 = 0.090$.
...
\begin{enumerate}
    ...
    ($b_1 = 2$, $c_{\text{oracle}} = 17$ on the reference graph).
